...
const FeaturedEvents = (myEvent) => {
    ...
    const EventCard = ({ event }) => {
        ...
        return (
            <Card key={event.id} style={{ width: 248 }}>
                <img
                    src={'/src/assets/sign-in-side.jpg'}
                    alt={event.eventName}
                ...
                <CardContent>
                    ...
                    <Stack spacing={1} direction="column" mt={2}>
                        ...
                        <Link to={`/viewevent/${event.event_id}`} style={{ textDecoration: 'none' }}>
                            <Button variant="outlined" color="secondary" fullWidth>
                                View Event
                            </Button>
                        </Link>
    ...
    return (
        ...
        <>
        <Box>
        <EventCard key={myEvent.event.id} event={myEvent.event}/>
        <br />
        </Box>
